### unit-testing.component.spec.ts
```
...
/**
 * 1. TestBed (is the primary api)
 * 2. ComponentFixture (The ComponentFixture is a test harness)
 * 3. describe (describe is used to scope tests and it is used to declare them.)
 * 4. it (it is the function which provide jasmine framework)
 */
